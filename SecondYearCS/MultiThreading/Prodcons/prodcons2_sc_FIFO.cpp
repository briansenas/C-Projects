...
void ProdCons1SC::escribir( int valor )
{
    ...
    while ( celdas == num_celdas_total )
        libres.wait( guarda );

    assert (celdas < num_celdas_total);
...
void funcion_hebra_productora( ProdCons1SC * monitor, int n_hebra)
{
