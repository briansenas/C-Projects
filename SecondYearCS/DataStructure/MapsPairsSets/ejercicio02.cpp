//
// Created by brian on 12/20/2020.
//
...
int main() {
    ...
    string cad1 = "Gwnfs%Xjsf%Xnrtsx";
    string cad2 = "Fufxx|twi678";
    string cad3 = "VznjwtHfkȮUqx";
    ...
    cout << "Result: " << desencripta(cad1, codigo) << endl;
    cout << "############# End Test Sample ##############" << endl;

    cout << "############# Test Sample 2 ##############" << endl;
    cout << "Sample: " << cad2 << endl;
    cout << "Result: " << desencripta(cad2, codigo) << endl;
    cout << "############# End Test Sample ##############" << endl;

    cout << "############# Test Sample 3 ##############" << endl;
    cout << "Sample: " << cad3 << endl;
    cout << "Result: " << desencripta(cad3, codigo) << endl;
    cout << "############# End Test Sample ##############" << endl;
