...
int main() {
    ...
    for (map<string, int>::const_iterator it = res1.begin();
         it != res1.end(); it++) {
        cout << it->first << " se repite: " << it->second << endl;
    }
    ...
    for (map<string, int>::const_iterator it = res2.begin();
         it != res2.end(); it++) {
        cout << it->first << " se repite: " << it->second << endl;
    }
    cout << "############# End Test Sample ##############" << endl;
    ...
    for (map<string, int>::const_iterator it = res3.begin();
         it != res3.end(); it++) {
        cout << it->first << " se repite: " << it->second << endl;
    }
    cout << "############# End Test Sample ##############" << endl;
