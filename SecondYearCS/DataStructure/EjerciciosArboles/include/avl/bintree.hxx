			    ...
			    bintree<T> & orig)
{
  ...
  int num_left = count(n.left());

  destroy(orig.laraiz);
  num_nodos = num_nodos - num_left;
  orig.laraiz = n.left();
  orig.num_nodos = num_left;
  if (!orig.laraiz.null())
			     ...
			     bintree<T> & orig)
{
  ...
  int num_right = count(n.right());

  destroy(orig.laraiz);
  num_nodos = num_nodos - num_right;
  orig.laraiz = n.right();
  orig.num_nodos = num_right;
  if (!orig.laraiz.null())
    orig.laraiz.parent(typename bintree<T>::node());
