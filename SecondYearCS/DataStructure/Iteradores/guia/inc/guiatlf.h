...
public:
    using ValueType = pair<string,string>;
    //Guia_Tlf(){}
    ...
    */
    ...
    class Iterator {
    private:
        typename map<string, string>::iterator m_Ptr;
    public:
        Iterator() : m_Ptr(0) {}

        Iterator(map<string,string>::iterator ptr) : m_Ptr(ptr) {}
        ...
        pair<string,string> operator[](int index){
    ...
    {
        private:
        typename map<string, string>::const_iterator m_Ptr;
        public:
        ConstIterator() : m_Ptr(0) {}

        ConstIterator(map<string,string>::const_iterator ptr) : m_Ptr(ptr) {}
    ...
    Iterator begin() {
        Guia_Tlf::Iterator it;
        it.m_Ptr = datos.begin();
        return it;
    }


    ConstIterator cbegin() {
        Guia_Tlf::ConstIterator it;
        it.m_Ptr = datos.begin();
        return it;
    }
