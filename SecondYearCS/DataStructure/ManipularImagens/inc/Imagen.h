...
/**
 * @brief Tipo de datos a implementar
 *
 * De esta manera podemos ahorrarnos tiempo al declarar
 * el tipo de variable usigned char.
 */
...
public:
     ...
     */
    void asigna_pixel(int nf, int nc,byte valor);
     ...
     */
    byte valor_pixel(int nf, int nc);
